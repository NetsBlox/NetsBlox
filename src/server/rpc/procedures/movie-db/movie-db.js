...
const movieInfo = function(id, field) {
...
const personInfo = function(id, field) {
    var rsp = this.response;
...
const movieCredits = function(id, field, subfield) {
    var rsp = this.response;
...
const personImages = function(id, field, subfield) {
    var rsp = this.response;
...
const personCredits = function(id, field, subfield) {
    var rsp = this.response;
