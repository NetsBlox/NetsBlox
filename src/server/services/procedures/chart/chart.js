 ...
 * @param {Array=} options.labels labels for each line
 * @param {Array=} options.types types for each line
 * @param {Array=} options.xRange range of X values to graph
 * @param {Array=} options.yRange range of Y values to graph
