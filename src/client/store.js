...
NetsBloxSerializer.prototype.app = 'NetsBlox 1.4.0, http://netsblox.org';  // Make this version automatic
...
NetsBloxSerializer.prototype.rawLoadProjectModel = function (xmlNode) {
    ...
    if (model.pentrails) {
        ...
        project.pentrails.onload = function () {
            var context = project.stage.trailsCanvas && project.stage.trailsCanvas.getContext('2d');
